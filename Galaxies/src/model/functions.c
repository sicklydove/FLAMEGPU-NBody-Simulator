 ...
 * Functions.c prototypes automatically generated by scripted template.
 * Remainder of code (function bodies) author: Laurence James
 * Contact: ljames1@sheffield.ac.uk or laurence.james@gmailcom
 */
...
__FLAME_GPU_INIT_FUNC__ void initConstants(){
	...
	//Get vis settings in customVisualisation.cu
